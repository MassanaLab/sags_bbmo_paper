...
#SBATCH --job-name=diamond_reads-vs-marferret
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=12
#SBATCH --output=data/logs/diamond_reads-vs-marferret_%A_%a.out
#SBATCH --error=data/logs/diamond_reads-vs-marferret_%A_%a.err
#SBATCH --array=1-32%4
...
DB='data/db/MarFERReT.v1.1.1.proteins.noSAGs.dmnd'
DB_NAME=marferret
